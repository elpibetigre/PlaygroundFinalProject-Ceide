...
urlpatterns = [
    ...
    path('profesores/nuevo', views.Crear_Profesor.as_view(), name="Nuevo_Profesor"),
    path('profesores', views.Listar_Profesores.as_view(), name="Lista_Profesores"),
    path('profesores/<pk>', views.Detallar_Profesor.as_view(), name="Detalle_Profesor"),
    path('profesores/<pk>/editar', views.Editar_Profesor.as_view(), name="Editar_Profesor"),
    path('profesores/<pk>/borrar', views.Borrar_Profesor.as_view(), name="Borrar_Profesor"),
    path('entregables/nuevo', views.Crear_Entregable.as_view(), name="Nuevo_Entregable"),
    path('entregables/lista', views.Listar_Entregables.as_view(), name="Lista_Entregables"),
    path('entregables/<pk>', views.Detallar_Entregables.as_view(), name="Detalle_Entregable"),
    path('entregables/<pk>/editar', views.Editar_Entregables.as_view(), name="Editar_Entregable"),
    path('entregables/<pk>/borrar', views.Borrar_Entregable.as_view(), name="Borrar_Entregable"),
